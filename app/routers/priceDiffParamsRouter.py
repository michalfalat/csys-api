...
@price_diff_params_router.get('/price-diff-params', tags=['Price Diff Params'], response_model=List[PriceDiffParamsSchema], status_code=200)
...
@price_diff_params_router.post('/price-diff-params', tags=['Price Diff Params'], response_model=PriceDiffParamsSchema, status_code=201)
...
@price_diff_params_router.get('/price-diff-params/last', tags=['Price Diff Params'], response_model=PriceDiffParamsSchema, status_code=200)
